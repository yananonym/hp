...
\input{content/02-axioms}

\section{Dirichlet Forms and the Minimal Upper Gradient}
\input{content/03-dirichlet-forms}
...
\input{content/07-critical-measure}

\section{Spectral Encoding of Riemann Zeros}
\input{content/08-spectral-encoding}
...
\input{content/09-os-positivity}

\section{The Riemann Hypothesis: Synthesis and Proof}
\input{content/10-main-theorem}
...
\input{content/A1-technical-lemmas}

\section{Verification Roadmap and Status}
\input{content/A2-verification-roadmap}

\section{Non-Circularity Analysis}
\input{content/A3-non-circularity}

\section{Tier 1--3 Verification: Complete Calculations}
\input{content/A4-tier1-tier3-verification}
