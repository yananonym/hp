...
Higher-order polynomial terms (degree 6, 8, etc.) would create additional fine structure in the spectrum but preserve the three-channel decomposition. Thus, the quartic case is canonical and sufficient for the RH proof.
\end{remark}
...
These axioms are not chosen arbitrarily; they represent the minimal mathematical structure required for Hilbert--Pólya-type constructions.
