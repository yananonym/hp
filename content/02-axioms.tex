...
\begin{axiom}[Configuration Space Structure]
...
\item[(II.iii)] \textbf{Polynomial Growth}: The potential $V: [0, \infty) \to \bbR$ satisfies:
$$V(s) \geq c_1 s^p - C, \quad |V'(s)| \leq c_2(1 + s^{p-1})$$
for constants $c_1, c_2, C > 0$ and $p > 0$.

\item[(II.iv)] \textbf{Smoothness}: $V \in C^\infty([0, \infty); \bbR)$.
