...
\item[Tier 1: Routine Application of Established Theorems] These use well-known results with published proofs. No new calculations are required.

\item[Tier 2: Explicit Verification Required] These require explicit calculations but use standard techniques. The calculations are lengthy but straightforward.

\item[Tier 3: Potential Research Frontier] These are plausible but would benefit from detailed computational support.
